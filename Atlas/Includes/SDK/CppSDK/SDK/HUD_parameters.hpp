...
public:
	...
	TDelegate<void(const struct FEndOfDayRecap& EndOfDayRecap)> K2Node_CreateDelegate_OutputDelegate7; // 0x00A8(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(const TArray<class UFortQuestItem*>& Quests)> K2Node_CreateDelegate_OutputDelegate16; // 0x0498(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(const struct FGameplayTagContainer& HiddenHUDElementTags)> K2Node_CreateDelegate_OutputDelegate17; // 0x04A8(0x0010)(ZeroConstructor, NoDestructor)
};
