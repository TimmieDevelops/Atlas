...
public:
	...
	TDelegate<void(const struct FFortPlayerDeathReport& DeathReport)> K2Node_CreateDelegate_OutputDelegate4; // 0x0138(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(const TArray<class UFortWorldItem*>& ItemsAdded, const TArray<class UFortWorldItem*>& ItemsRemoved)> K2Node_CreateDelegate_OutputDelegate6; // 0x0160(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(const struct FFortPlayerDeathReport& DeathReport)> K2Node_CreateDelegate_OutputDelegate14; // 0x01E0(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(const TArray<class UFortWorldItem*>& ItemsAdded, const TArray<class UFortWorldItem*>& ItemsRemoved)> K2Node_CreateDelegate_OutputDelegate18; // 0x0228(0x0010)(ZeroConstructor, NoDestructor)
