...
// Parameters:
// const class FString&                    Country                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
...
// (Event, Public, HasOutParams, BlueprintEvent)
// Parameters:
// const class FText&                      EulaText                                               (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const class FString&                    LoginEmail                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
// const class FString&                    LoginPassword                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
